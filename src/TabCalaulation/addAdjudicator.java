...
public class addAdjudicator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField6.setToolTipText("Institution name e.g. PUSTDS");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Adjudicator's institution", "Adjudicator name"
            }
        ) {
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        adminPage adj = getAdmin();
        adj.setVisible(true);
        adj.setAddAdjudicator(this);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addAdjudicator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addAdjudicator().setVisible(true);
            }
        });
    }
