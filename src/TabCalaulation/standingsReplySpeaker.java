...
public class standingsReplySpeaker extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reply Speaker Standings");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Rank", "Speaker's institution", "Speaker name", "Total point"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(standingsReplySpeaker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new standingsReplySpeaker().setVisible(true);
            }
        });
    }
