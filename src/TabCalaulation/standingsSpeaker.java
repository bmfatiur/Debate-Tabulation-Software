...
public class standingsSpeaker extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Speaker Standings");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(standingsSpeaker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new standingsSpeaker().setVisible(true);
            }
        });
    }
